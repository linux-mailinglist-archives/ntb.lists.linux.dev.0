Return-Path: <ntb+bounces-1017-lists+linux-ntb=lfdr.de@lists.linux.dev>
X-Original-To: lists+linux-ntb@lfdr.de
Delivered-To: lists+linux-ntb@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id C9F069B66DB
	for <lists+linux-ntb@lfdr.de>; Wed, 30 Oct 2024 16:03:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id EAF6C1C21449
	for <lists+linux-ntb@lfdr.de>; Wed, 30 Oct 2024 15:03:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B69D51F4FDC;
...
Received: from mail-relay.contabo.net (mail-relay.contabo.net [207.180.195.6])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4E6011E885F
	for <ntb@lists.linux.dev>; Wed, 30 Oct 2024 15:02:40 +0000 (UTC)
...
Received: from pxmg2.contabo.net (localhost.localdomain [127.0.0.1])
	by mail-relay.contabo.net (Proxmox) with ESMTP id 099D47C26DF
	for <ntb@lists.linux.dev>; Wed, 30 Oct 2024 15:55:02 +0100 (CET)
Received: from m2712.contaboserver.net (m2712.contaboserver.net [91.194.91.201])
	by mail-relay.contabo.net (Proxmox) with ESMTPS id C5D2C7C26B1
	for <ntb@lists.linux.dev>; Wed, 30 Oct 2024 15:55:01 +0100 (CET)
