Return-Path: <ntb+bounces-1780-lists+linux-ntb=lfdr.de@lists.linux.dev>
Delivered-To: lists+linux-ntb@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id +ETvD8QHimluFQAAu9opvQ
	(envelope-from <ntb+bounces-1780-lists+linux-ntb=lfdr.de@lists.linux.dev>)
	for <lists+linux-ntb@lfdr.de>; Mon, 09 Feb 2026 17:13:56 +0100
X-Original-To: lists+linux-ntb@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id A4C6A112609
	for <lists+linux-ntb@lfdr.de>; Mon, 09 Feb 2026 17:13:55 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 9E8553012C97
	for <lists+linux-ntb@lfdr.de>; Mon,  9 Feb 2026 16:13:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C13613806BE;
...
Received: from AM0PR02CU008.outbound.protection.outlook.com (mail-westeuropeazon11013016.outbound.protection.outlook.com [52.101.72.16])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3816136F425
	for <ntb@lists.linux.dev>; Mon,  9 Feb 2026 16:13:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=52.101.72.16
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1770653633; cv=fail; b=tJSFBX4TKG2Z/XwKMTfXtvLsZhmYC8GXzp6Y5XhcmdnjQl4jyglccLMqTzu3M2cp6rVPHU+rSEJjyAeEZThoeWwbvnimJu9vS/M37VsEFDohhvcZ9PV9nUh4gJNfSkIFDUirfQDoB0Ojah1v0HK0xOOxya8N4qhE7qizdzW77JU=
...
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com; spf=pass smtp.mailfrom=nxp.com; dkim=pass (2048-bit key) header.d=nxp.com header.i=@nxp.com header.b=A4+M+Pg+; arc=fail smtp.client-ip=52.101.72.16
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-1780-lists,linux-ntb=lfdr.de];
	FROM_HAS_DN(0.00)[];
	MIME_TRACE(0.00)[0:+];
	...
	MISSING_XM_UA(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,nxp.com:dkim,valinux.co.jp:email]
X-Rspamd-Queue-Id: A4C6A112609
